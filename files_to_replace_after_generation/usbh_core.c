...
{
	//TODO: JS -- maybe this is a problem because it assumes the active class is the first interface in the device descriptor? not always true)
	//seems to be user facing though and never is called internally.
